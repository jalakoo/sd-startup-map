...
def sidebar():
    ...
    with st.sidebar:
        ...
        ## -------------------------------------------------------------------------------------------------
            ...
            # Add New/ Edit Startup Form
            # if "map_data" in st.session_state:
            #     st.header("Edit Startup:")
            #     with st.form("Edit Startup"):
            #         name = st.text_input(
            #             label="Name",
            #             value=st.session_state.map_data["last_object_clicked_tooltip"],
            #         )
            #         # st.write(st.session_state.map_data["last_object_clicked_tooltip"])
            #         # st.button(
            #         #     label="Save",
            #         #     # on_click=auth_functions.save_startup,
            #         #     type="primary",
            #         # )
